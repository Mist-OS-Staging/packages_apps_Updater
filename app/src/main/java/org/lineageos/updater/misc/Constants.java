...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.mist.build.version";
    public static final String PROP_DEVICE = "ro.mist.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "mist.updater.allow_downgrading";
